...
class RegionSeeder extends Seeder
{
    ...
    {
        $this->command->info('Feetching Provinces');
        ...
        foreach ($provinces as $province) {
            ...
            $this->command->info("Feetching Regencies for {$province['name']}...");
            ...
            foreach ($regencies as $regency) {
                ...
                $this->command->info("Feetching Districts for {$regency['name']}...");
                ...
                foreach ($districts as $district) {
                    ...
                    $this->command->info("Feetching Village for {$district['name']}...");
