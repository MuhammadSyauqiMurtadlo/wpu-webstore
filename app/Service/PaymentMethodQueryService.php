...
class PaymentMethodQueryService
{
    ...
    {
        return $this->getDriver($sales_order->paymentd_river)->shouldShowPayNowButton($sales_order);
    }

    public function getRedirectUrl($sales_order): ?string
    {
        return $this->getDriver($sales_order->paymentd_river)->getRedirectUrl($sales_order);
    }
}
