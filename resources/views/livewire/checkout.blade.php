        ...
        <div class="grid gap-5 md:gap-20 md:grid-cols-2">
                ...
                <div
                    ...
                    <div class="mt-2 space-y-3">
                        ...
                        @error('data.address_line')
                            <p class="mt-2 text-xs text-red-600" id="hs-validation-shipping-line-error-helper">
                                {{ $message }}
                            </p>
                        @enderror
                        <div>
                    ...
                    <div class="grid space-y-2">
                        @foreach ($this->payment_methods->toCollection() as $key => $payment_method)
                            <label for="payment_method_{{ $payment_method->hash }}"
                                ...
                                <input type="radio" wire:key="{{ $payment_method->hash }}"
            ...
            <div class="p-10">
                ...
                <div class="grid gap-5">
                    ...
                    <!-- End List Group -->
                    <button type="button" wire:click="placeAndOrder" wire:loading.attr="disabled"
